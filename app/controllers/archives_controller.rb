class ArchivesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @archive.save
        format.html { redirect_to @archive, notice: 'Archívum sikeresen létrehozva.' }
  ...
  def update
    respond_to do |format|
      if @archive.update(archive_params)
        format.html { redirect_to @archive, notice: 'Archívum sikeresen frissítve.' }
  ...
  private
    ...
    def archive_params
      params.require(:archive).permit(:title, :body, :img, :adate)
    end
end
